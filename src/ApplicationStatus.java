...
public class ApplicationStatus {
	...
	private void setStatus(String statusDescription)
	{
		...
		else if (statusDescription.equalsIgnoreCase("Applied")) {this.statusCode = "APPL";}
		else if (statusDescription.equalsIgnoreCase("Denied")) {this.statusCode = "DENY";}
		else if (statusDescription.equalsIgnoreCase("Conditionally Admitted")) {this.statusCode = "COND";}
		else if (statusDescription.equalsIgnoreCase("Admitted")) {this.statusCode = "ADMT";}
		else if (statusDescription.equalsIgnoreCase("Withdrawn")) {this.statusCode = "WADM";}
		else if (statusDescription.equalsIgnoreCase("Offer Accepted")) {this.statusCode = "DEIN";}
		else if (statusDescription.equalsIgnoreCase("Decision Deffered")) {this.statusCode = "DDEF";}
		else if (statusDescription.equalsIgnoreCase("On Waiting List")) {this.statusCode = "WAIT";}
		else if (statusDescription.equalsIgnoreCase("Firm Offer Deferred")) {this.statusCode = "WAPP";}
		else if (statusDescription.equalsIgnoreCase("Conditional Admittance Revoked")) {this.statusCode = "ADRV";}
		else if (statusDescription.equalsIgnoreCase("Offer Rejected")) {this.statusCode = "WAPP";}
		else if (statusDescription.equalsIgnoreCase("Deffered")) {this.statusCode = "DEFR";}
	...
	private void setReason(String statusReason)
	{
		...
		else if (statusReason.equalsIgnoreCase("Applicant submitted application")) {this.reasonCode = "SBMT";}
		else if (statusReason.equalsIgnoreCase("Applicant withdraws application")) {this.reasonCode = "WDRN";}
		else if (statusReason.equalsIgnoreCase("Applicant reconsider programme of study")) {this.reasonCode = "ALT";}
		else if (statusReason.equalsIgnoreCase("HOD / Programme Convenor must decide")) {this.reasonCode = "HOD";}
		else if (statusReason.equalsIgnoreCase("Faculty Admittance Committee must decide")) {this.reasonCode = "RFAC";}
		else if (statusReason.equalsIgnoreCase("Waiting for Information")) {this.reasonCode = "INFO";}
		else if (statusReason.equalsIgnoreCase("Waiting for English Proficiency Results")) {this.reasonCode = "LANG";}
		else if (statusReason.equalsIgnoreCase("Waiting for External Tertiary results")) {this.reasonCode = "TERT";}
		else if (statusReason.equalsIgnoreCase("Waiting for UCT results")) {this.reasonCode = "TUCT";}
		else if (statusReason.equalsIgnoreCase("No Special Reason")) {this.reasonCode = "GENW";}
		else if (statusReason.equalsIgnoreCase("Defer decision of making firm offer")) {this.reasonCode = "GAP";}
		else if (statusReason.equalsIgnoreCase("Application re-instated")) {this.reasonCode = "REIN";}
		else if (statusReason.equalsIgnoreCase("Faculty Office withdraws application due to applicant changing programme choice")) {this.reasonCode = "CHNG";}
		else if (statusReason.equalsIgnoreCase("Faculty Office withdraws application due to fraudalent information")) {this.reasonCode = "RFAD";}
		else if (statusReason.equalsIgnoreCase("Faculty Office withdraws application due to necessary documentation not provided")) {this.reasonCode = "ICOM";}
		else if (statusReason.equalsIgnoreCase("Faculty Office withdraws application due to offer beinf made on another application in faculty")) {this.reasonCode = "OFFER";}
		else if (statusReason.equalsIgnoreCase("Faculty Office withdraws application due to programme unavailability")) {this.reasonCode = "PWIT";}
		else if (statusReason.equalsIgnoreCase("Faculty Office withdraws application due to never registered")) {this.reasonCode = "CLAP";}
		else if (statusReason.equalsIgnoreCase("Conditional Offer withdrawn as admission conditions not met")) {this.reasonCode = "COND";}
		else if (statusReason.equalsIgnoreCase("On condition of cetified transcript")) {this.reasonCode = "CERT";}
		else if (statusReason.equalsIgnoreCase("On condition of receipt of relevant information")) {this.reasonCode = "RCPT";}
		else if (statusReason.equalsIgnoreCase("On condition of school-leaving results")) {this.reasonCode = "RSLT";}
		else if (statusReason.equalsIgnoreCase("On condition of final results")) {this.reasonCode = "RES";}
		else if (statusReason.equalsIgnoreCase("On condition of final tertiary results")) {this.reasonCode = "TERT";}
		else if (statusReason.equalsIgnoreCase("Special Offer for Top Applicants")) {this.reasonCode = "STAR";}
		else if (statusReason.equalsIgnoreCase("Firm Offer Made")) {this.reasonCode = "CONF";}
		else if (statusReason.equalsIgnoreCase("Application denied due to competition")) {this.reasonCode = "COMP";}
		else if (statusReason.equalsIgnoreCase("Application denied due to late application")) {this.reasonCode = "LATE";}
		else if (statusReason.equalsIgnoreCase("Application denied due to inadequate research proposal")) {this.reasonCode = "PROP";}
		else if (statusReason.equalsIgnoreCase("Application denied due to inappropriate supervisor")) {this.reasonCode = "SUPV";}
